...
# =============================================================================
# BURGER RUSH - TESTE DA REESTRUTURAÇÃO COMPLETA DO TUTORIAL INICIAL (18 ETAPAS)
# =============================================================================
...
func run_all_tests() -> void:
	print("\n=================================================================")
	print("=== BURGER RUSH - TESTE DA REESTRUTURAÇÃO COMPLETA DO TUTORIAL ===")
	print("=================================================================\n")
	...
	sm.set_custom_save_dir("user://saves_test_new_tutorial")
	root.add_child(sm)
	...
	var tray_stack = ServingTrayStackClass.new()
	main_scene.add_child(tray_stack)
	tray_stack.name = "ServingTrayStack"
	tray_stack.global_position = Vector3(2.0, 0.0, 2.0)
	...
	print("\n--- TESTE 1: Inicialização e Contagem de Etapas ---")
	assert_test(tut.steps.size() == 18, "Tutorial possui exatamente 18 etapas estruturadas")
	assert_test(tut.current_step_index == 0, "Tutorial inicia na etapa 0")
	assert_test(clock.is_paused == true, "Relógio pausado durante o tutorial")
	assert_test(pm.is_main_power_on == true, "Energia ligada para o tutorial")

	# ETAPA 0: Movimentação
	print("\n--- TESTE 2: Etapa 0 (Movimentação, Corrida e Pulo) ---")
	...
	print("\n--- TESTE 3: Etapa 1 (Quadro Geral de Energia) ---")
	...
	print("\n--- TESTE 4: Etapa 2 (PC Administrativo) ---")
	...
	print("\n--- TESTE 5: Etapa 3 (Reposição e Compras) ---")
	tut.step_initialized = true
	if pc.computer_ui_instance:
	...
	# ETAPA 4: Recebimento de Mercadorias
	print("\n--- TESTE 6: Etapa 4 (Recebimento e Estoque) ---")
	...
	print("\n--- TESTE 7: Etapa 5 (Máquinas do Restaurante) ---")
	...
	print("\n--- TESTE 8: Etapa 6 (Grelhando Carne Crua) ---")
	...
	# ETAPA 7: Virando com Espátula
	print("\n--- TESTE 9: Etapa 7 (Virando com Espátula) ---")
	patty.flip()
	tut._check_step_conditions()
	assert_test(tut.current_step_index == 8, "Avançou para Etapa 8 (Retirando Hambúrguer)")

	# ETAPA 8: Retirando Hambúrguer Pronto com Espátula
	print("\n--- TESTE 10: Etapa 8 (Retirando Hambúrguer com Espátula) ---")
	...
	print("\n--- TESTE 11: Etapa 9 (Montagem na Bancada) ---")
	...
	# ETAPA 10: Limpeza da Grelha e Bucha
	print("\n--- TESTE 12: Etapa 10 (Limpeza e Higiene) ---")
	player.held_item = null
	...
	assert_test(grill.is_dirty() == false, "Grelha inicia limpa")
	
	# Simula sujeira acumulada e limpeza com bucha
	grill.add_dirt(0.5)
	assert_test(grill.is_dirty() == true, "Grelha detecta sujeira (> 0.001)")
	sponge.play_scrub_animation()
	grill.clean_progress(1.0, player)
	grill.dirt_level = 0.0
	assert_test(sponge.is_dirty == true, "Bucha ficou suja após limpeza")
	...
	# ETAPA 11: Embalagem do Lanche
	print("\n--- TESTE 13: Etapa 11 (Embalagem do Lanche) ---")
	...
	print("\n--- TESTE 14: Etapa 12 (Preparo de Bebidas) ---")
	...
	print("\n--- TESTE 15: Etapa 13 (Salão, Drive-Thru e Delivery) ---")
	...
	print("\n--- TESTE 16: Etapa 14 (Sistema de Bandejas) ---")
	...
	print("\n--- TESTE 17: Etapa 15 (Horário e Expediente) ---")
	...
	print("\n--- TESTE 18: Etapa 16 (Pagamentos e Caixa) ---")
	...
	print("\n--- TESTE 19: Etapa 17 (Conclusão e Início do Dia 1) ---")
	tut._check_step_conditions()
	...
	# Teste do clique no botão "Começar Dia 1"
	tut._complete_tutorial(false)
	assert_test(tut.tutorial_completed == true, "tutorial_completed marcado como true")
	assert_test(sm.pending_save_data.get("tutorial_completed") == true, "tutorial_completed persistido no SaveManager")
	assert_test(clock.is_paused == false, "Relógio despausado após o tutorial")
	...
	if passed_tests == total_tests:
		print(">>> SUCESSO TOTAL: TODAS AS 18 ETAPAS E SISTEMAS VALIDADOS! <<<\n")
		quit(0)
	else:
